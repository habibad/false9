            ...
            <div class="content-detail">
                ...
                <form class="signup-form" method="post">
                    ...
                    <div class="imgcontainer">
                        <img style="width:300px; height: 100px;" src="<?php echo get_theme_file_uri(); ?>/user-dashboard/Groupbackground.png" alt="logo"
                    ...
                    <div class="input-control">
                        ...
                        <div class="login-with-btns">
                            <span class="already-acc">Already you have an account? <a
                                    href="<?php echo esc_url(get_permalink(get_page_by_path('user-login'))); ?>"
